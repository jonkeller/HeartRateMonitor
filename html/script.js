/*
Adapted from http://bl.ocks.org/aogriffiths/7933339
*/
...
function drawgraph(){
  ...
  var y_dim_accessor = function(d){return d.beats};

  var x_range;
  var y_range;
  
  // create a simple data array that we'll plot with a line (this array represents only the Y values, X will just be the index location)
  d3.json("hrm.php", function(error, json){
    var data;
  ...
  function render(data){
    ...
    var line = d3.svg.line()
      ...
      // create xAxis
      var xAxis = d3.svg.axis().scale(x).tickSize(-h).tickSubdivide(true).ticks(12);
